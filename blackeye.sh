#!/bin/bash
# BLACKEYE v1.0 is an upgrade from original ShellPhish Tool (https://github.com/enigma-edu) by enigma-edu under GNU LICENSE 
# Coded by: @enigma-edu (https://github.com/enigma-edu)
...
printf "\n"
printf "     \e[101m\e[1;77m::     BLACKEYE v1.5! By @enigma-edu     ::\e[0m\n"
printf "\n"
}
